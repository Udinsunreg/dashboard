...
import SmartFarmingCRUD from "@/components/smartfarming-crud"
            ...
            <Tabs defaultValue="map" className="h-full">
              <div className="border-b px-6">
                <TabsList className="mt-2">
                  ...
                  <TabsTrigger value="data">Data Smart Farming</TabsTrigger>
                </TabsList>
              </div>
              ...
              <TabsContent value="data" className="p-6 h-[calc(100%-48px)] overflow-auto">
                <SmartFarmingCRUD />
              </TabsContent>
            </Tabs>
          </div>
