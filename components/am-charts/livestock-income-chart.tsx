...
export function LivestockIncomeChart() {
  ...
  useEffect(() => {
    ...
    const renderChart = () => {
      ...
      columnSeries1.columns.template.setAll({
        ...
        fillOpacity: 0.5,
        fill: window.am5.color(0xd97706), // amber-600
        strokeOpacity: 0,
      })
      ...
      // Target sales column series (narrower, darker amber)
      ...
      columnSeries0.columns.template.setAll({
        ...
        fill: window.am5.color(0x92400e), // amber-800
        strokeOpacity: 0,
      })
      ...
      const series0 = chart.series.push(
        window.am5xy.SmoothedXLineSeries.new(root, {
          ...
          tooltip: window.am5.Tooltip.new(root, {
            pointerOrientation: "horizontal",
            labelText: "{name}: {valueY} Ribu Rp/Kg",
          }),
        }),
      )
